...
var sizelim = 600
var shaqqed = false
$('#obiggy').css({'width':sizelim+globalnum+'px', 'height':sizelim+globalnum+'px'})
...
function Enemy(type, enenum) {
  ...
  if(type === 'Ghost') {
    enm.attr('src', '/static/imgs/fish.png')
    this.health = 150
    this.dmg = 10
    this.xpearned = 5
    this.effchance = 0
    ...
    enm.attr('src', '/static/imgs/seaweed.png')
    this.health = 200
    this.dmg = 20
    this.xpearned = 10
    this.effchance = 40
    ...
    enm.attr('src', '/static/imgs/shark.png')
    this.health = 75
    this.dmg = 100
    this.xpearned = 20
    this.effchance = 10
...
function Block() {
  ...
  x = Math.ceil(x / globalnum) * globalnum;
  y = Math.ceil(y / globalnum) * globalnum;
  var blk = $(`<img src="/static/imgs/rock.png" class="block">`)
